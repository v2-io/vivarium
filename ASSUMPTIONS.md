...
| planetary water inventory | **ABSENT** — no water-mass ledger exists at frame level; "sea level" is a datum, not a volume | — | **missing** | declare inventory (earth-ref modern: ocean **1.34×10⁹ km³** [Eakins & Sharman 2010, via Chowdhury 2025 — cited, replacing the from-memory 1.39] ≈ 2.6 km global-equivalent; atmosphere ≈0.001% ≈ 25 mm — *still from memory*). Early Earth: **water generous but contested** (Dong ~1.3 OM central [0.8–2.3]); **basins ~modern-or-shallower, NOT 5–6 km** (majority synthesis; corrected 2026-07-10 — inventory and basin depth are independent levers). The placeholder's ~0.3 km pan stays wrong for every era |
