...
2. **Seed-identity is now theorem-grounded, not intuition**: the query class that depends on the seed-coordinatization surplus (every mod/patch/law-change fork held on this background) is exactly characterized. "The nomos + seed constitute the world's noumenon" is a theorem, not a joke.
