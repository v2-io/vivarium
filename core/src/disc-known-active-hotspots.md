...
8. **Instrument / ops notes (revised 2026-07-31).** Not leverage rank:
   - **Explorer LoD + performance (Joseph requisition 2026-07-29) — passes 2026-07-31.** (1) Latest-wins request drain. (2) Camera blends to nadir when close. (3) Whole-globe ceiling L7. (4) Auto-level steps ≤1. (5) **Window is altitude-gated** — never a postage-stamp region at 3900 km just because level is L9. (6) **Key-side frustum** before decode — a 182² window no longer loads ~400 planet region payloads (the 6.7 s pull). Residual: no coarse shell under a fine window; true quadtree still open.
