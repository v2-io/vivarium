...
- **Dual homes demoted:** discretisation graduated; NOMOS-CONTRACT bias adjudication section; `.super-archive/from-archive/CLAUDE.md`. Worked MFD / θ / clip specimens stay in DECISIONS + measurement homes.
