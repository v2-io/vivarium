...
6. **Measured / declared residuals (homes elsewhere; do not re-derive).**
   ...
   | Partial-tile **edge sinks** as base level | grades every tile to its own perimeter — no closed depressions, basins capped at the tile, seam pits on assembly | #obs-tile-outlets-grade-away-the-basins |
