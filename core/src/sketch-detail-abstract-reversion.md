...
- **Rename executed here (2026-07-24)** per the wavelet-store decision's instruction ("rename it to what it really is; do not close it and do not leave it as written") — the segment now carries the split rather than the pre-spike statement. History: ARCHITECTURE §8 correction trail.
