...
- **Face ocean + P3 (2026-07-31):** explore samples face-domain ocean at ≤L9; first-light rebuilt (~3552 fresh erosion, world `7216c8dca`). Open ≤L7 pure prior by coverage — zoom for fluvial. **P4 instrument bar met** pending Joseph eyes; closed-water-cycle still honest red.
