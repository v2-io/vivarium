...
| Type | Aspect | Tag | Claim | Stage |
| --- | --- | --- | --- | --- |
| formulation | Physics Critical | [#form-isostasy-column](src/form-isostasy-column.md) | Lithosphere column + Airy read live; mantle-thermal cooling nomos drives emergence in time (water-world → in-band present → cooling); rock-mass ledger returns erosion mass + isostatic rebound (measured operator, trims the amber over-stand toward the band); emerged-land Claimed by isostasy (not Kept) | draft |
