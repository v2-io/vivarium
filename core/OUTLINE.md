...
| formulation | Math Critical | [#form-same-level-halo-exchange](src/form-same-level-halo-exchange.md) | A same-level tile seam owes a datum and a flux; Jacobi halo at declared $(d,\sigma,\rho)$ supplies the datum, and its key is a descriptor not a payload — unbuilt design | draft |
