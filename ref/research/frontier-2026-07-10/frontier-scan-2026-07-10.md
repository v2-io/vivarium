...
- **Relata registrations — DEFERRED (relata under heavy construction, 2026-07-10; revisit after the refactor).** Pending: **CCB\*18** (`cordonnier-2018-sculpting`, IEEE TVCG 24(5):1756–1769 — already *cited* in `doc/design/DESIGN-SYSTEMS.md`, unregistered), plus any ⭐ items promoted to citable use. See the durable note in `BIBLIOGRAPHY.md`.
