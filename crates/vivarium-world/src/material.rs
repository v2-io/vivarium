//! Materials — the property bundle every physics rung reads (#form-material-property-interface
...
impl MaterialId {
    ...
    /// erosion/hydrology tiers can move (#form-column-control-volume / #form-material-property-interface).
